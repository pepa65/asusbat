...
```
wget https://github.com/pepa65/batlimit/releases/download/0.10.12/batlimit
...
## Usage
```
batlimit 0.10.12 - Set battery charge limit on supported laptops on Linux with CLI
